...
Bracket.Utilities = {
	...
	ClosePopUps = function()
		for Index, Object in pairs(Bracket.Screen:GetChildren()) do
			if Object.Name == "OptionContainer" or Object.Name == "DropdownPopup" or Object.Name == "Palette" then
...
Bracket.Instances = {
	...
	Window = function()
		...
		TabButtonContainer.AnchorPoint = Vector2.new(0, 0)
		TabButtonContainer.Size = UDim2.new(0, 110, 1, -25)
		TabButtonContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
		TabButtonContainer.Position = UDim2.new(0, 6, 0, 25)
		...
		TabContainer.Size = UDim2.new(1, -128, 1, -25)
		TabContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
		TabContainer.BackgroundTransparency = 1
		TabContainer.Position = UDim2.new(0, 122, 0, 25)
	...
	Tab = function()
		...
		SubTabContainer.AnchorPoint = Vector2.new(0, 0)
		SubTabContainer.Size = UDim2.new(1, 0, 1, -24)
		SubTabContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
		SubTabContainer.BackgroundTransparency = 1
		SubTabContainer.Position = UDim2.new(0, 0, 0, 24)
		SubTabContainer.BorderSizePixel = 0
		SubTabContainer.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		SubTabContainer.Parent = Tab

		local SubTabButtonContainer = Instance.new("ScrollingFrame")
		SubTabButtonContainer.Name = "SubTabButtonContainer"
		SubTabButtonContainer.ZIndex = 3
		SubTabButtonContainer.AnchorPoint = Vector2.new(0, 0)
		SubTabButtonContainer.Size = UDim2.new(1, 0, 0, 18)
		SubTabButtonContainer.BorderColor3 = Color3.fromRGB(0, 0, 0)
		SubTabButtonContainer.Position = UDim2.new(0, 0, 0, 0)
		SubTabButtonContainer.Active = true
		SubTabButtonContainer.BorderSizePixel = 2
		SubTabButtonContainer.BackgroundColor3 = Color3.fromRGB(31, 31, 31)
		SubTabButtonContainer.ScrollingDirection = Enum.ScrollingDirection.X
		SubTabButtonContainer.CanvasSize = UDim2.new(0, 0, 0, 0)
		SubTabButtonContainer.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
		SubTabButtonContainer.MidImage = "rbxassetid://6432766838"
		SubTabButtonContainer.ScrollBarThickness = 0
		SubTabButtonContainer.TopImage = "rbxassetid://6432766838"
		SubTabButtonContainer.VerticalScrollBarInset = Enum.ScrollBarInset.ScrollBar
		SubTabButtonContainer.BottomImage = "rbxassetid://6432766838"
		SubTabButtonContainer.Parent = Tab

		local ListLayout = Instance.new("UIListLayout")
		ListLayout.Name = "ListLayout"
		ListLayout.FillDirection = Enum.FillDirection.Horizontal
		ListLayout.SortOrder = Enum.SortOrder.LayoutOrder
		ListLayout.Parent = SubTabButtonContainer
		...
		Stroke.LineJoinMode = Enum.LineJoinMode.Miter
		Stroke.Color = Color3.fromRGB(63, 63, 63)
		Stroke.Parent = SubTabButtonContainer

		return Tab
	end,
	SubTab = function()
		local SubTab = Instance.new("ScrollingFrame")
		SubTab.Name = "SubTab"
		SubTab.Visible = false
		SubTab.AnchorPoint = Vector2.new(0.5, 0.5)
		SubTab.Size = UDim2.new(1, 0, 1, 0)
		SubTab.BorderColor3 = Color3.fromRGB(0, 0, 0)
		SubTab.BackgroundTransparency = 1
		SubTab.Position = UDim2.new(0.5, 0, 0.5, 0)
		SubTab.Active = true
		SubTab.BorderSizePixel = 0
		SubTab.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		SubTab.ScrollingDirection = Enum.ScrollingDirection.Y
		SubTab.CanvasSize = UDim2.new(0, 0, 0, 0)
		SubTab.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
		SubTab.MidImage = "rbxassetid://6432766838"
		SubTab.ScrollBarThickness = 0
		SubTab.TopImage = "rbxassetid://6432766838"
		SubTab.VerticalScrollBarInset = Enum.ScrollBarInset.ScrollBar
		SubTab.BottomImage = "rbxassetid://6432766838"
	...
	TabButton = function()
		...
		Highlight.Size = UDim2.new(0, 2, 1, -4)
		Highlight.BorderColor3 = Color3.fromRGB(0, 0, 0)
		Highlight.Position = UDim2.new(0, -6, 0.5, 0)
	...
	DropdownPopup = function()
		...
		PopupContainer.Name = "DropdownPopup" -- Name kept same so ClosePopUps works
...
Bracket.Templates = {
	...
	Window = function(Window)
		...
		if not Window.LegacyTabButtons then
			WindowInstance.TabButtonContainer.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
				WindowInstance.TabButtonContainer.CanvasSize = UDim2.fromOffset(0, WindowInstance.TabButtonContainer.ListLayout.AbsoluteContentSize.Y)
			end)
		end
	...
	Tab = function(Tab, Window)
		...
		if Window.LegacyTabButtons then
			...
			TabButtonInstance.Size = UDim2.new(1, 0, 0, 24)
		else
	...
	SubTab = function(SubTab, ParentTab, Window)
		SubTab = Bracket.Utilities:GetType(SubTab, "table", {}, true)
		SubTab.Name = Bracket.Utilities:GetType(SubTab.Name, "string", "SubTab")

		local SubTabInstance = Bracket.Instances.SubTab()
		local SubTabButtonInstance = Bracket.Instances.SubTabButton()
		
		local function ChooseSubTab(TabInstance, ButtonInstance, FrameInstance)
			Bracket.Utilities.ClosePopUps()
			for Index, Object in pairs(TabInstance.SubTabContainer:GetChildren()) do
				if Object:IsA("ScrollingFrame") then
					Object.Visible = Object == FrameInstance
				end
			end
			for Index, Object in pairs(TabInstance.SubTabButtonContainer:GetChildren()) do
				if Object:IsA("TextButton") then
					Object.Highlight.Visible = Object == ButtonInstance
				end
			end
		end

		local TabButtonColorable = SubTabButtonInstance.Highlight
		local TabButtonTitle = SubTabButtonInstance

		SubTab.Type = "Tab" -- behave like tab for elements
		SubTab.Instance = SubTabInstance
		SubTab.ButtonInstance = SubTabButtonInstance
		SubTab.Window = Window

		SubTab.ColorConfig = {TabButtonColorable, "BackgroundColor3", true}
		Window.Colorable[#Window.Colorable + 1] = SubTab.ColorConfig
		Bracket.Elements[#Bracket.Elements + 1] = SubTab

		SubTabInstance.Parent = ParentTab.Instance.SubTabContainer
		SubTabButtonInstance.Parent = ParentTab.Instance.SubTabButtonContainer
		TabButtonTitle.Text = SubTab.Name

		SubTabButtonInstance.Highlight.BackgroundColor3 = Window.Color
		SubTabButtonInstance.Size = UDim2.new(0, TabButtonTitle.TextBounds.X + 12, 1, 0)
		SubTabButtonInstance:GetPropertyChangedSignal("TextBounds"):Connect(function()
			SubTabButtonInstance.Size = UDim2.new(0, TabButtonTitle.TextBounds.X + 12, 1, 0)
		end)

		SubTabInstance.LeftSide.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
			local Side = Bracket.Utilities.GetLongestSide(SubTabInstance)
			SubTabInstance.CanvasSize = UDim2.fromOffset(0, Side.ListLayout.AbsoluteContentSize.Y + 16)
		end)
		SubTabInstance.RightSide.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
			local Side = Bracket.Utilities.GetLongestSide(SubTabInstance)
			SubTabInstance.CanvasSize = UDim2.fromOffset(0, Side.ListLayout.AbsoluteContentSize.Y + 16)
		end)
		SubTabButtonInstance.MouseButton1Click:Connect(function()
			ChooseSubTab(ParentTab.Instance, SubTabButtonInstance, SubTabInstance)
		end)

		if #ParentTab.Instance.SubTabContainer:GetChildren() == 1 then
			ChooseSubTab(ParentTab.Instance, SubTabButtonInstance, SubTabInstance)
		end
	...
	Dropdown = function(Dropdown, ParentElement, Window)
		...
		local PopupContainerInstance = Bracket.Instances.DropdownPopup()
		PopupContainerInstance.Parent = Bracket.Screen
		...
		function Dropdown.Clear(Self)
			for Index, Option in pairs(Dropdown.List) do
				Option.InlineInstance:Destroy()
				Option.PopupInstance:Destroy()
			end
		...
		function Dropdown.AddOption(Self, Option, LayoutOrder)
			...
			local InlineInstance = Bracket.Instances.DropdownOption()
			local PopupInstance = Bracket.Instances.DropdownOption()

			Option.Type = "Option"
			Option.InlineInstance = InlineInstance
			Option.PopupInstance = PopupInstance
			Option.ParentElement = Dropdown
			Option.Window = Window

			-- Color config needs to handle BOTH ticks, but ColorConfig format only supports one instance per config natively.
			-- We will manually update them.
			...
			InlineInstance.Tick.BackgroundColor3 = Option.Value and Window.Color or Color3.fromRGB(63, 63, 63)
			InlineInstance.LayoutOrder = LayoutOrder

			PopupInstance.Parent = PopupContainerInstance.ListContainer
			PopupInstance.Title.Text = Option.Name
			PopupInstance.Tick.BackgroundColor3 = Option.Value and Window.Color or Color3.fromRGB(63, 63, 63)
			...
			PopupInstance.MouseButton1Click:Connect(OnOptionClicked)

			InlineInstance.Title:GetPropertyChangedSignal("TextBounds"):Connect(function()
				InlineInstance.Title.Size = UDim2.new(1, -(InlineInstance.Layout.ListLayout.AbsoluteContentSize.X + 18), 1, 0)
			end)
			PopupInstance.Title:GetPropertyChangedSignal("TextBounds"):Connect(function()
				PopupInstance.Title.Size = UDim2.new(1, -(PopupInstance.Layout.ListLayout.AbsoluteContentSize.X + 18), 1, 0)
			end)

			Option:GetPropertyChangedSignal("Name"):Connect(function(Name)
				InlineInstance.Title.Text = Name
			...
			for Index, Value in pairs(Option.Internal) do
				if string.find(Index, "Colorpicker") then
					-- For nested colorpickers inside toggles (we bind them to InlineInstance since that's the primary layout)
		...
		Dropdown.Internal.Value = Dropdown.Value
		for Index, Option in pairs(Dropdown.List) do
